...
import { advancedNextJsQuestions } from "./advanceQuestion";

export default function NextJsQuiz() {
  const [isAnswerVisible, setIsAnswerVisible] = useState<boolean[]>(new Array(advancedNextJsQuestions.length).fill(false));
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto bg-gradient-to-r from-indigo-200 to-purple-300 rounded-xl shadow-lg">
      ...
      <div className="space-y-8">
        {advancedNextJsQuestions.map((question, index) => (
          <div
            key={index}
